...
| Endpoint | Method | URL |
|----------|--------|-----|
| Top Stories | GET | `https://app-c6jsx92bbkld-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top` |
| All News | GET | `https://app-c6jsx92bbkld-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all` |
| Similar News | GET | `https://app-c6jsx92bbkld-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}` |
| News by UUID | GET | `https://app-c6jsx92bbkld-api-qYGWo8XA7M7Y.gateway.appmedo.com/v1/news/uuid/{uuid}` |
| Sources | GET | `https://app-c6jsx92bbkld-api-oLpZ7eD5jJ5a.gateway.appmedo.com/v1/news/sources` |

Base host: `app-c6jsx92bbkld-api-wL1zlEdVM6DY.gateway.appmedo.com`
